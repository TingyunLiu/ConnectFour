...
from implementation import quick_to_win_player, alpha_beta_player, better_evaluate, my_player, focused_evaluate
...
if __name__ == '__main__':
    ...
    parser.add_argument('mode', type=str, help='Mode for playing Connect Four.',
                        choices=['X', 'O', 'computer', 'quick', 'alphabeta', 'my_player', 'basic_vs_my_player', 'my_player_vs_basic', 'debug_evaluate', 'rand'])
    ...
    if args.mode == 'X':
    ...
    elif args.mode == 'basic_vs_my_player':
        ...
        print("{} => {}".format(test_board_1, focused_evaluate(test_board_1)))
        # better evaluate from player 2
        print("{} => {}".format(test_board_2, focused_evaluate(test_board_2)))
        # better evaluate from player 1
